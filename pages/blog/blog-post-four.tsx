...
const Article = () => {
    return (
        ...
        <PageLayout blogcentered>
            ...
            <br/>
            <LinkTo href="https://github.com/lambert-alex/blog-react/blob/main/pages/blog/blog-post-four.tsx" className="my-2 py-2 px-4 mx-w-fit border rounded flex items-center justify-center transition-all duration-700 hover:bg-indigo-600 hover:text-white font-semibold">This blog is an example of accessible web design. See the code and look at the uses of h2, title, list, br and Link elements on this page.</LinkTo>
